...
<body>
    ...
    <div class="zentaiwaku"> <!-- 전체 와꾸 다 합친 와꾸-->
        ...
        <div class="line2"> <!-- 빈칸, 카테고리 와꾸-->
            ...
            <input type="text" name="q_title" placeholder="제목을 입력하세요"/><!-- 제목입력칸-->
        ...
        <div class="textsty"> <!-- 글꼴굵기 글꼴기울기 글꼴....-->
            <button><img src="${root}/images/notice/bold.png" width="15px" height="15px"></button>
            <button><img src="${root}/images/notice/italic-text.png" width="15px" height="15px"></button>
            <button><img src="${root}/images/notice/underline.png" width="15px" height="18px"></button>
        </div>
        <div style="border: white; width: 1200px; height: 8px;"></div><!-- 한칸띄우기-->
        <div class="blenk"> <!-- 텍스트박스 와꾸-->
            <textarea name="q_content" class="writingbox" placeholder="내용을 입력하세요"></textarea>
        </div>
        <div style="border: white; width: 1200px; height: 16px;"></div><!-- 한칸띄우기-->
        <div class="footer"> <!-- 하단 와꾸-->
            <input type="submit" value="작성완료"/>
        </div>
    </div>
    <input name="n_num" value="${numSess}"/>
    </form>
</body>
</html>