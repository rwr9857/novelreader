...
<script type="text/javascript">
	...
	window
		.open(
			'https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=k7RIM1ejpagn8MbzDO3E&redirect_uri=http://localhost:8181/novelreader/member/naverlogin.do&state=dc1bf16a5614dbb206e9b9629154c1ef',
			'naver',
	...
	<c:if test="${numSess == null}">
		<div class="loginbox">
			<form name="memberForm" action="${root}/member/registerOk.do" method="post">
				...
				<input class="registerbutton" type="submit" value="가입하기" /> <input type="hidden" name="m_platform" value="local" />
