...
<head>
    ...
    <link rel="stylesheet" href="${root}/css/manager/memberDelete.css">
...
<body>
    <div style="margin-left:265px; margin-top : 0px; border:1px solid black; height:1100px; background : rgb(234 240 253);">
        <div class ="menuText">
            <h1>회원 삭제</h1>
            <h3>관리자 모드 -> <span style="color : gray;">회원정보</span> -> 회원 삭제</h3>
        </div>
        <div class = "serchbar">
            <h3>회원 닉네임</h3>
            <form>
		...
		<c:if test="${count > 0}">
			<c:forEach var="memberDto" items="${memberList}">
				<div class="resultTextpage">
					...
					<form action="${root}/manager/memberDeleteOk.do" method="post">
						<input type="hidden" name="m_num" value="${memberDto.m_num}"/>
